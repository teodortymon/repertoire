...
var clndrTemplate = "<div class='clndr-controls'>" +
    "<div class='clndr-control-button'><span class='clndr-previous-button'>poprzedni</span></div><div class='month'><%= month %> <%= year %></div><div class='clndr-control-button rightalign'><span class='clndr-next-button'>następny</span></div>" +
    "</div>" +
...
//    "</thead>" +
    ...
    "<% for(var i = 0; i < numberOfRows; i++){ %>" +
      ...
      "<canvas class='grow' id='canvas' width='60' height='60'></canvas></div></td>" +
      "<% } %>" +
      "</tr>" +
    "<% } %>" +
    "</tbody>" +
...
//          || nextMonth.format("YYYY-MM") <= this._clndrEndDateObject.format("YYYY-MM");
  ...
  Clndr.prototype.createDayObject = function(day, monthEvents) {
    ...
    $.each(eventsToday, function(index){
        extraClasses += " " + eventsToday[index]["theatre"];
    });
//    console.log(eventsToday);
  ...
  Clndr.prototype.render = function() {
    ...
    if(!this.options.render) {
      this.calendarContainer.html(this.compiledClndrTemplate(data));
        window.EventsThisMonth = data.eventsThisMonth;
    } else {
    ...
    for (a=0; a<daysArray.length; ++a){
            if(moment(daysArray[a].date).isValid()){
            plotData(daysArray[a].events, 'calendar-day-' + daysArray[a].date.format('YYYY-MM-DD'), daysArray[a].date.format('D'));
            };
        };
  };
  ...
  Clndr.prototype.addEvents = function(events) {
    ...
    Clndr.prototype.removeEvents = function(events) {
    // go through each event and add a moment object
    if(this.options.multiDayEvents) {
      this.options.events = _.difference(this.options.events, this.addMultiDayMomentObjectsToEvents(events));
    } else {
      this.options.events = _.difference(this.options.events,this.addMomentObjectToEvents(events));
    }
    this.render();
    return this;
  };
...
;var krakow = {
    'theatresEvents': { 
        "teatr1": [
            { date: '2014-09-04 15:30', title: 'BAdadasafd', theatre: 'teatr1'  },
            { date: '2014-09-12 10:00', title: 'dfsdf',  theatre: 'teatr1' },
            { date: '2014-09-24 18:40', title: 'fsdfsd',  theatre: 'teatr1' },
        ],
        
        "teatr2": [
            { date: '2014-09-12 18:30', title: 'AAA', theatre: 'teatr2'},
            { date: '2014-09-13 18:30', title: 'AAA', theatre: 'teatr2'},
            { date: '2014-09-14 18:30', title: 'AAA', theatre: 'teatr2'},
        ]
    },
            
    'theatresNames': { 
            "teatr1": "Teatr Pierwszy",
            "teatr2": "Teatr Drugi",
        }
};;var warszawa = {
    'theatresEvents': { 
        "narodowy": [
            { date: '2014-09-04 15:30', title: 'Big Premiera', theatre: 'narodowy'  },
            { date: '2014-09-12 10:00', title: 'dfsdf',  theatre: 'narodowy' },
            { date: '2014-09-24 18:40', title: 'fsdfsd',  theatre: 'narodowy' },
        ],
        
        "powszechny": [
            { date: '2014-09-12 18:30', title: 'AAA', theatre: 'powszechny'},
            { date: '2014-09-13 18:30', title: 'AAA', theatre: 'powszechny'},
            { date: '2014-09-14 18:30', title: 'AAA', theatre: 'powszechny'},
        ],
        
        "wspolczesny": [
            { date: '2014-09-12 18:30', title: 'BBB', theatre: 'wspolczesny'},
            { date: '2014-09-22 18:30', title: 'BBB', theatre: 'wspolczesny'},
            { date: '2014-09-23 18:30', title: 'BBB', theatre: 'wspolczesny'},
            { date: '2014-09-24 18:30', title: 'BBB', theatre: 'wspolczesny'},
        ],
        
        "tr": [
            { date: '2014-09-12 18:30', title: 'CCC', theatre: 'tr'},
            { date: '2014-09-22 18:30', title: 'CCC', theatre: 'tr'},
            { date: '2014-09-24 18:30', title: 'CCC', theatre: 'tr'},
            { date: '2014-09-26 18:30', title: 'CCC', theatre: 'tr'},
        ],
    },
            
    'theatresNames': { 
            "narodowy": "Teatr Narodowy",
            "powszechny": "Teatr Powszechny",
            "wspolczesny": "Teatr Współczesny",
            "tr": "Teatr Rozmaitości",
        }
};
